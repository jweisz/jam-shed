...
def test_get_notes_in_key_c_major():
    ...
    notes = MusicTheory.get_notes_in_key("C", "Major", octaves=[4])
...
def test_get_notes_in_key_multiple_octaves():
    ...
    notes = MusicTheory.get_notes_in_key("C", "Major", octaves=[3, 4])
...
def test_get_progression_chords_blues():
    ...
    chords = MusicTheory.get_progression_chords("C", "Major", "12-Bar Blues")
